...
export declare type THookFunction<TModel, T extends Express.Request> = (req: T, res: Express.Response, next: Express.NextFunction, model: Model<TModel>) => void;
export declare type IHookFunctionOrArr<TModel, T extends Express.Request> = THookFunction<TModel, T> | Array<THookFunction<TModel, T>>;
